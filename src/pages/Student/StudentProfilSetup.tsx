...
import { Plus, Search, Star, ArrowLeft, Bookmark } from 'lucide-react'
  ...
  const renderStep = () => {
    switch (step) {
      case 1:
        return (
          <div className="space-y-4">
            <h2 className="text-md font-semibold text-gray-800">Select the course To continue</h2>
        ...
        return (
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                {coaches.map((coach) => (
                  <div key={coach.id} className="bg-white p-4 rounded-lg shadow">
            ...
            {selectedCoach && (
              <div className="flex justify-center mt-6">
                <Button onClick={handleNext} className="bg-blue-500 text-white">Continue</Button>
              </div>
            )}
          </div>
        );
