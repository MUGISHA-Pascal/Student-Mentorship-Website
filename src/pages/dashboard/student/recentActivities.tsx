...
const RecentActivities: React.FC = () => {
  ...
  return (
    <div className="flex space-x-8 px-7 mt-5">
      ...
      <div className="flex-1 p-4">
        <div className="rounded-xl border shadow-md p-5">
          ...
          <div className="mt-4 space-y-2">
            <div className="bg-gray-50 p-2 rounded-lg border shadow">
      ...
      <div className="flex-1">
        <Calendar
          ...
          value={selectedDate}
          className="shadow-lg border border-blue-500 font-semibold rounded-lg p-2"
        />
      </div>
