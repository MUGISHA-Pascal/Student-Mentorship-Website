    ...
    >
      ...
      <nav className="space-y-2 flex-grow">
        <SidebarLink
          icon={<Home />}
          label="Home"
          isActive={activeSection === "/student/dashboard"}
          onClick={() => onSectionChange("/student/dashboard")}
        ...
        <SidebarLink
          icon={<Users />}
          label="Mentor"
          isActive={activeSection === "/student/dashboard/mentor"}
          onClick={() => onSectionChange("/student/dashboard/mentor")}
          to="/student/dashboard/mentor"
          expanded={expanded}
        />
        <SidebarLink
          icon={<Calendar />}
          label="Calendar"
          isActive={activeSection === "/student/dashboard/calendar"}
          onClick={() => onSectionChange("/student/dashboard/calendar")}
        ...
        {/* <SidebarLink
          ...
          onClick={() => onSectionChange("/student/dashboard/chat")}
        ...
        <SidebarLink
          icon={<FileText />}
          label="Docs"
          isActive={activeSection === "/student/dashboard/docs"}
          onClick={() => onSectionChange("/student/dashboard/docs")}
          to="/student/dashboard/docs"
          expanded={expanded}
        />
